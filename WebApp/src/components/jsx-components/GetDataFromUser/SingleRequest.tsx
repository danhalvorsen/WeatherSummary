...
export const  SingleRequest: FC<Iprops> =  ({date , cityName})=>{
    ...
    const source = "https://localhost:5000/api/weatherforecast/between?BetweenDateQuery.From=2022-05-01&BetweenDateQuery.To=2022-06-21&CityQuery.City=stavanger";
    useEffect(()=>{
