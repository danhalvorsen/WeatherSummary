...
INSERT INTO WeatherData 
	(Id, FK_CityID, [Date], Temperature, Windspeed, WindDirection, WindspeedGust, Pressure, Humidity, ProbOfRain, AmountRain, CloudAreaFraction, FogAreaFraction, ProbOfThunder)
VALUES
...
INSERT INTO  SourceWeatherData
	(Id, FK_WeatherDataId, FK_SourceId, ConnectionDate)
VALUES
	(1, 1, 1, GETDATE()),
	(2, 2, 2, GETDATE()),
	(3, 3, 3, GETDATE()),
